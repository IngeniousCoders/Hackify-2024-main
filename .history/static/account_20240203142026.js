...
function validateSignupForm() {
    ...
    window.location.href = 'my_home_page.html';
    return true;
}
function validateLoginForm() {
    ...
    window.location.href = '/templates/terms_and_conditions.html';
    return true;
}
function submitSignup() {
    ...
    if (!isFormValid) /* If the form is not valid, show the invalidity on screen */ {
        ...
        fetch("../login", {
            ...
            .then(data => {
                window.location.href = '/templates/terms_and_conditions.html'; // Redirect to the terms and conditions file
            });
    }
        password.reportValidity();
        password_confirm.reportValidity();
